...
using GenderHealthcare.DAL; // for GenderHealthcareContext
                    ...
                    .ConfigureServices((context, services) =>
                    {
                        ...
                        services.AddDbContextFactory<GenderHealthcareContext>(options =>
                            options.UseSqlServer(
                                "Server=LAPTOP-13VQ2HGC\\SQLEXPRESS;uid=sa;pwd=12345;database=gender_healthcare_db;TrustServerCertificate=True"
